...
const Navbar = () => {
  ...
  return (
    <nav>
      ...
      <a href="#intern" onClick={() => setActiveNav('#intern')} className={activeNav === '#intern' ? 'active':''}><BsFillLaptopFill/></a>
      <a href="#achievement" onClick={() => setActiveNav('#achievement')} className={activeNav === '#achievement' ? 'active':''}><GiAchievement/></a>
      <a href="#workshop" onClick={() => setActiveNav('#workshop')} className={activeNav === '#workshop' ? 'active':''}><MdShopTwo/></a>
